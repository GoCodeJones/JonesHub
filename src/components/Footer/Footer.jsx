  ...
  return (
    <footer className="footer">
      ...
      <div className="socials">
        ...
        <a href="#" className="social github" title="GitHub">
        ...
        <a href="#" className="social youtube" title="YouTube">
        ...
        <a href="#" className="social twitter" title="X">
          <svg viewBox="0 0 24 24"><path d="M18.9 2H22l-6.5 7.4L23 22h-6.8l-5.3-7-6.1 7H2l7-8-7-12h7l4.8 6.4L18.9 2z"/></svg>
        </a>

        <a href="#" className="social telegram" title="Telegram">
          <svg viewBox="0 0 24 24"><path d="M9.4 16.6 9 20.5c.5 0 .7-.2 1-.5l2.3-2.2 4.8 3.5c.9.5 1.5.2 1.7-.8l3.1-14.6c.3-1.3-.5-1.8-1.4-1.5L1.6 9.4C.3 9.9.3 10.7 1.4 11l4.9 1.5L18 5.6c.5-.3.9-.1.5.2"/></svg>
        </a>
